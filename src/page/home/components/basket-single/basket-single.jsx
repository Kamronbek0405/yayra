    ...
    return (
        <div className= 'w-[100%] overflow-hidden py-20  lg:w-[100%] lg:h-[100vh] relative justify-center items-center flex-col flex'>
            <div className='lg:flex lg:items-center    '>
                <Button className='absolute bottom-16 left-32 px-9 py-5 text-lg md:bottom-14 md:left-[350px] md:px-10 md:py-6 lg:top-[40px] lg:left-20 hover:bg-transparent hover:text-blue-500 hover:border-2 hover:border-blue-500 lg:px-9 lg:py-5' onClick={exitClick}>ortga</Button>
            <h1 className='text-5xl text-blue-500 font-bold tracking-widest'>Shopping</h1>
            </div>
