    ...
    return (
        <div className='w-[100%]  px-2 '>
           ...
           <span className='  text-lg font-medium text-blue-500 text-center'>{topText.toUpperCase()}</span>
            ...
            <div className='bg-cover bg-no-repeat ml-3 md:ml-8  w-[350px] h-[150px] mt-10 md:w-[745px] md:h-[350px] lg:w-[1250px] lg:h-[580px] lg:mt-20 flex flex-col items-start justify-center relative ' style={{ backgroundImage: `url(${clinetsBgImg})` }}>
                ...
                <img className=' w-[50px] h-[50px] -left-2 md:w-[150px] md:h-[150px] md:-left-10 lg:w-[250px] lg:h-[250px] absolute lg:-left-20 ' src={clietsImg} alt="user-img" />
            </div>
        </div>
    )
}
